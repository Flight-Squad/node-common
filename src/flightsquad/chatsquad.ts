...
export class Chatsquad {
    ...
    send = {
        msg: (req: SendMessageReq) => Axios.post(`${this.apiRoot}/${Chatsquad.routes.messages.msg}`, req),
        payment: async (req: PaymentMessageReq): Promise<void> => {await Axios.post(`${this.apiRoot}/${Chatsquad.routes.messages.payment}`, req)}
    }
}